<main>
        ...
        <div class="section pt-5 position-relative">
            ...
            <div class="mx-xl-5 overflow-visible position-absolute bottom-0 start-0 end-0">
                <div class="d-flex flex-xl-row flex-column gap-3" style="padding-bottom: 6em;">
                    ...
                    <div class="col mb-3 mb-xl-0 scrollanimation animated fadeInRight">
                        <div class="d-flex flex-column h-100 align-items-xl-start align-items-center text-xl-start text-center gap-xl-5 gap-3 p-5 bg-accent-primary"
                            style="border-top-left-radius: 20px;">
                            <p>
                                Discover a wide range of high-quality medical products designed to support your health
                                and well-being. From prescription medications to over-the-counter essentials.
                            </p>
                            <div class="d-flex flex-xl-row flex-column gap-5 align-items-center">
                                <div class="w-max-content">
                                    <a href="contact.html" class="btn btn-accent d-flex flex-row gap-3">
                                ...
                                <div class="d-flex flex-row gap-3 align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="flex-row">
                                            ...
                                            <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                                            <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                                            <i class="fa-solid fa-star" style="color: var(--grey-light);"></i>
                                        </div>
                                        <span class="testimonial-name">(1.5k+ Reviews)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="section bg-attach-cover" style="background-image: url(image/bg_about.html);">
            <div class="r-container">
                <div class="row row-cols-xl-2 row-cols-1">
                    ...
                    <div class="col mb-3">
                        <div
                            class="d-flex flex-column gap-3 text-xl-start text-center ps-xl-4 pe-3 h-100 justify-content-between">
                            ...
                            <div class="w-max-content">
                                <a href="about.html" class="btn btn-accent d-flex flex-row gap-3">
        ...
        <div class="section p-0">
            <div class="d-flex flex-column gap-3 text-center align-items-center justify-content-center mx-auto position-relative my-5 accent-primary">
                <div class="marquee-container bg-gradient-right" style="transform: rotate(3deg); position: relative;">
                    <div class="marquee-content green-neon">
                        ...
                        <div class="marquee-item py-2 d-flex align-items-center justify-content-center">
                            <h3 class="m-0">InvesSecurity &amp; Profitsment</h3>
                        </div>
                        <div class="marquee-item py-2 d-flex align-items-center">
                            <i class="rtmicon rtmicon-global-economy" style="font-size: 45px;"></i>
                        </div>
                ...
                <div class="row row-cols-xl-2 row-cols-1 align-items-center">
                    <div class="col mb-3">
                        <div class="overflow-hidden position-relative">
                            ...
                            <div class="swiper swiperTeam w-100">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card card-overlay gap-3">
                                            <div class="card-image overflow-hidden rounded-0 position-relative">
                                                ...
                                                <div class="card-body">
                                                    <div
                                                        class="d-flex flex-column gap-2 h-100 w-100 text-white justify-content-between p-4">
                                                        <div class="px-3 py-1 bg-glass">
                                                            <span class="small-text">Credit Analyst</span>
                                                        </div>
                                            ...
                                            <div class="card-image overflow-hidden rounded-0 position-relative">
                                                ...
                                                <div class="card-body">
                                                    <div
                                                        class="d-flex flex-column gap-2 h-100 w-100 text-white justify-content-between p-4">
                                                        <div class="px-3 py-1 bg-glass">
                                                            <span class="small-text">Financial Analyst</span>
                                                        </div>
                                                        <div class="d-flex flex-column gap-2">
                                                            <h5>Adam Lewis</h5>
                                                            <div class="social-container"
                                            ...
                                            <div class="card-image overflow-hidden rounded-0 position-relative">
                                                ...
                                                <div class="card-body">
                                                    <div
                                                        class="d-flex flex-column gap-2 h-100 w-100 text-white justify-content-between p-4">
                                                        <div class="px-3 py-1 bg-glass">
                                                            <span class="small-text">Tax Specialist</span>
                                                        </div>
                                                        <div class="d-flex flex-column gap-2">
                                                            <h5>Roberto Clark</h5>
                                                            <div class="social-container"
                                            ...
                                            <div class="card-image overflow-hidden rounded-0 position-relative">
                                                ...
                                                <div class="card-body">
                                                    <div
                                                        class="d-flex flex-column gap-2 h-100 w-100 text-white justify-content-between p-4">
                                                        <div class="px-3 py-1 bg-glass">
                                                            <span class="small-text">Cost Accountant</span>
                                                        </div>
                                                        <div class="d-flex flex-column gap-2">
                                                            <h5>Diana Queen</h5>
                                                            <div class="social-container"
                    ...
                    <div class="col mb-3">
                        <div class="d-flex flex-column gap-4 ps-xl-5">
                            <div class="sub-heading">
                                <h6 class="m-0">Our Team</h6>
                            </div>
                            <h3>Building Wealth Through Strategic Investments</h3>
                            <p>We specialize in creating tailored investment strategies that maximize growth, minimize
                                risk, and help you achieve long-term financial success.</p>
                            <div class="w-max-content">
                                <a href="team.html" class="btn btn-accent d-flex flex-row gap-3">
                                    <span>All Team</span>
                                    <i class="rtmicon rtmicon-arrow-up-right fw-bold"></i>
                                </a>
                            </div>
        ...
        <div class="section">
            <div class="r-container d-flex flex-column gap-3 bg-gradient-right pt-5 px-5 accent-primary"
                ...
                <div class="row row-cols-xl-2 row-cols-1 align-items-center floating-counter">
                    ...
                    <div class="col mb-3 mb-xl-0 p-0">
                        <div class="p-5 bg-accent-primary radius-partner">
                            <div class="swiper swiperPartner w-100">
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="partner">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140 30"
                                                ...
                                                <path
                                                    ...
                                                    class="ccompli2" fill="CurrentColor" />
                                                <path
                                                    ...
                                                    class="ccompli1" fill="CurrentColor" />
                                                <path
                                                ...
                                                <path d="M39.317 6.655H42.287V21.108H39.317V6.655Z" class="cneutral"
                                                    fill="CurrentColor" />
                                                <path
                                                    ...
                                                    class="cneutral" fill="CurrentColor" />
                                                <path
                                    ...
                                    <div class="swiper-slide">
                                        <div class="partner">
                                            <svg xmlns="http://www.w3.org/2000/svg" id="logo-2" width="132" height="35"
                                                viewBox="0 0 132 35" fill="CurrentColor">
                                                <path
                                    ...
                                    <div class="swiper-slide">
                                        <div class="partner">
                                            <svg xmlns="http://www.w3.org/2000/svg" id="logo-29" width="154" height="44"
                                                viewBox="0 0 154 44" fill="CurrentColor">
                                                <path d="M51.439 28V10.888H48.633V28H51.439Z" class="ccustom"
                                                    fill="CurrentColor" />
                                                <path
        ...
        <div class="section">
            <div class="r-container d-flex flex-column gap-3">
                ...
                <div class="row row-cols-xl-3 row-cols-1" style="margin-top: 50px;">
                        ...
                        <div class="card card-pricing">
                            <div class="d-flex flex-column gap-3 align-items-center" style="margin-top: -80px;">
                                <div class="bg-accent-color-2 custom-border-3">
                                    <i class="rtmicon rtmicon-rate"></i>
                                </div>
                                <div class="sub-heading rounded-pill">
                                    <h6 class="m-0">Basic Plan</h6>
                                </div>
                                <div class="d-flex flex-row heading mb-3 align-items-end">
                                    <h3 class="m-0">$500</h3>
                                    <span>/Monthly</span>
                                </div>
                                <p>For newcomers or those looking to establish a solid foundation in finance and
                                    investments.</p>
                                <div class="custom-border-4 w-100"></div>
                                <div class="d-flex flex-column gap-2">
                                    <div class="d-flex flex-row gap-3 align-items-center">
                    ...
                    <div class="col mb-xl-3 mt-xl-0 mb-5 mt-3 scrollanimation animated fadeInLeft">
                        <div class="card card-pricing">
                            <div class="d-flex flex-column gap-3 align-items-center" style="margin-top: -80px;">
                                <div class="bg-accent-color-2 custom-border-3">
                                    <i class="rtmicon rtmicon-profit"></i>
                                </div>
                                <div class="sub-heading rounded-pill">
                                    <h6 class="m-0">Premium Plan</h6>
                                </div>
                                <div class="d-flex flex-row heading mb-3 align-items-end">
                                    <h3 class="m-0">$1,500</h3>
                                    <span>/Monthly</span>
                                </div>
                                <p>For those seeking personalized investment strategies with a deeper level of insight.
                                </p>
                                <div class="custom-border-4 w-100"></div>
                                <div class="d-flex flex-column gap-2">
                                    <div class="d-flex flex-row gap-3 align-items-center">
                                    ...
                                    <div class="d-flex flex-row gap-3 align-items-center">
                                        <i class="rtmicon rtmicon-check-circle fs-4"></i>
                                        <span>Exclusive webinars & market updates</span>
                                    </div>
                                </div>
                                <a href="#" class="btn btn-accent d-flex flex-row gap-3 w-100">
                                    <span class="accent-primary">Select Package</span>
                    ...
                    <div class="col mb-xl-3 mt-xl-0 mb-5 mt-3 scrollanimation animated fadeInLeft">
                        <div class="card card-pricing">
                            <div class="d-flex flex-column gap-3 align-items-center" style="margin-top: -80px;">
                                <div class="bg-accent-color-2 custom-border-3">
                                    <i class="rtmicon rtmicon-global-economy"></i>
                                </div>
                                <div class="sub-heading rounded-pill">
                                    <h6 class="m-0">Elite Plan</h6>
                                </div>
                                <div class="d-flex flex-row heading mb-3 align-items-end">
                                    <h3 class="m-0">$5,000</h3>
                                    <span>/Monthly</span>
                                </div>
                                <p>For high-net-worth individuals and seasoned investors, the Elite Plan offers
                                    comprehensive.</p>
                                <div class="custom-border-4 w-100"></div>
                                <div class="d-flex flex-column gap-2">
                                    <div class="d-flex flex-row gap-3 align-items-center">
                                    ...
                                    <div class="d-flex flex-row gap-3 align-items-center">
                                        <i class="rtmicon rtmicon-check-circle fs-4"></i>
                                        <span>Tailored portfolio management</span>
                                    </div>
                                    <div class="d-flex flex-row gap-3 align-items-center">
                                        <i class="rtmicon rtmicon-check-circle fs-4"></i>
                                        <span>VIP support and 24/7 consultation</span>
                                    </div>
                                </div>
                                <a href="#" class="btn btn-accent d-flex flex-row gap-3 w-100">
                                    <span class="accent-primary">Select Package</span>
                ...
                <div
                    ...
                    <div class="w-max-content">
                        <a href="contact.html" class="btn btn-accent d-flex flex-row gap-2 px-4 py-3">
                            <span>Contact Us</span>
                            <i class="rtmicon rtmicon-arrow-up-right"></i>
                        </a>
                    </div>
        ...
        <div class="section">
            <div class="r-container position-relative">
                ...
                <div class="floating-cta bg-accent-primary py-4 px-5 d-flex flex-row gap-2 align-items-center justify-content-center green overflow-visible"
                    style="z-index: 3; border-top-left-radius: 20px;">
                    <span class="button-text">Play Video</span>
                    <button type="button" class="request-loader accent" data-bs-toggle="modal" data-bs-target="#e120">
                        <i class="rtmicon rtmicon-play-button"></i>
                    </button>
                </div>
            </div>
            <div class="modal fade" id="e120" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content bg-dark-color">
                        <iframe class="ifr-video" src="https://www.youtube.com/embed/FK2RaJ1EfA8?autoplay=1"></iframe>
                    </div>
            ...
            <div class="overflow-hidden w-100">
                <div class="swiper swiperTestimonials">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div
                                class="testimonial-container px-5 py-5 gap-3 justify-content-center align-items-center">
                                <div class="d-flex flex-column gap-3 text-center">
                                    <i class="rtmicon rtmicon-blockquote text-accent-2" style="font-size:64px;"></i>
                                    <span class="font-2 fst-italic">"I’ve been working with this team for over a year,
                                        and their financial advice has completely transformed my investment strategy.
                                        They helped me diversify my portfolio and now my returns are better than I ever
                                        imagined!"</span>
                                </div>
                                <div class="d-flex flex-xl-row flex-column gap-3 align-items-center">
                                    ...
                                    <div class="d-flex flex-column text-xl-start text-center">
                                        ...
                                        <span class="green">Investor</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div
                                ...
                                <div class="d-flex flex-column gap-3 text-center">
                                    <i class="rtmicon rtmicon-blockquote text-accent-2" style="font-size:64px;"></i>
                                    <span class="font-2 fst-italic">"As a first-time investor, I was overwhelmed by all
                                        the choices. But the team walked me through every step, explaining everything in
                                        simple terms. I feel much more confident about my investments now!"</span>
                                </div>
                                <div class="d-flex flex-xl-row flex-column gap-3 align-items-center">
                                    <div class="customer-item border-0">
                        ...
                        <div class="swiper-slide">
                            <div
                                ...
                                <div class="d-flex flex-column gap-3 text-center">
                                    <i class="rtmicon rtmicon-blockquote text-accent-2" style="font-size:64px;"></i>
                                    <span class="font-2 fst-italic">"The retirement planning services have been a huge
                                        help. The personalized approach they took made me feel confident about my
                                        financial future, and now I’m on track to retire comfortably ahead of
                                        schedule."</span>
                                </div>
                                <div class="d-flex flex-xl-row flex-column gap-3 align-items-center">
                                    <div class="customer-item border-0">
                        ...
                        <div class="swiper-slide">
                            <div
                                ...
                                <div class="d-flex flex-column gap-3 text-center">
                                    <i class="rtmicon rtmicon-blockquote text-accent-2" style="font-size:64px;"></i>
                                    <span class="font-2 fst-italic">"I can’t say enough about how impactful the
                                        Innovate 2024 conference was! The sessions were not only informative but
                                        also engaging. I returned to my company with fresh ideas and a
                                        network.”</span>
                                </div>
                                <div class="d-flex flex-xl-row flex-column gap-3 align-items-center">
                                    <div class="customer-item border-0">
        ...
        <div class="section">
            <div class="r-container d-flex flex-column gap-5 align-items-center">
                <div class="d-flex flex-column gap-2 align-items-center justify-content-center mx-auto text-center"
                    style="max-width: 700px;">
                    <div class="sub-heading">
                        <h6 class="m-0">Latest Article</h6>
                    </div>
                    <h3>Get Update and New Insight For Financial Future</h3>
                    <p>Stay ahead with the latest updates and expert insights to make informed decisions for a secure
                        financial future.</p>
                </div>
                <div class="row row-cols-xl-2 row-cols-1">
                    <div class="col mb-3">
                        <div class="card d-flex flex-column gap-4">
                            ...
                            <div class="d-flex flex-column gap-2 scrollanimation animated fadeIn adr-7">
                                ...
                                <p>
                                    From the rise of AI-driven investment strategies to growing interest in
                                    sustainable and green investments, staying ahead of trends is crucial
                                </p>
                                <div class="w-max-content">
                                    <a href="single_blog.html"
                                        class="read-more d-flex flex-row rounded-0 gap-2 px-0 py-2 align-items-center">
                                        <span>Read Post</span>
                                        <i class="rtmicon rtmicon-arrow-up-right fw-bold"></i>
                                    </a>
                                </div>
                    ...
                    <div class="col mb-3">
                        <div class="card d-flex flex-column gap-4">
                            ...
                            <div class="d-flex flex-column gap-2 scrollanimation animated fadeIn adr-7">
                                ...
                                <p>
                                    Creating a successful investment plan for retirement starts with setting clear
                                    goals, determining your risk tolerance, and understanding your time horizon.
                                </p>
                                <div class="w-max-content">
                                    <a href="single_blog.html"
                                        class="read-more d-flex flex-row rounded-0 gap-2 px-0 py-2 align-items-center">
                ...
                <div class="w-max-content scrollanimation animated zoomIn adr-7">
                    <a href="blog.html" class="btn btn-accent d-flex flex-row gap-3">
                        <span>View All</span>
                        <i class="rtmicon rtmicon-arrow-up-right fw-bold"></i>
                    </a>
                </div>
